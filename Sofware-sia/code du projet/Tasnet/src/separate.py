...
parser.add_argument('--mix_dir', type=str, default="C:/Users/alexa/OneDrive/Bureau/Source-audio-SIA/valid/mix",
                    help='Directory including mixture wav files')
parser.add_argument('--mix_json', type=str, default="C:/Users/alexa/OneDrive/Bureau/Source-audio-JSON/valid",
                    help='Json file including mixture wav files')
parser.add_argument('--out_dir', type=str, default="C:/Users/alexa/OneDrive/Bureau/resultat",
...
def separate(args):
    ...
    def write(inputs, filename, sr=args.sample_rate):
        siow.write(filename,sr,inputs)# norm=True)
