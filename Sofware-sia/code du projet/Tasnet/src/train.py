...
# General config
# Task related
parser.add_argument('--train_dir', type=str, default="C:/Users/alexa/OneDrive/Bureau/Source-audio-JSON/train",
                    help='directory including mix.json, s1.json and s2.json')
parser.add_argument('--valid_dir', type=str, default="C:/Users/alexa/OneDrive/Bureau/Source-audio-JSON/test",
                    help='directory including mix.json, s1.json and s2.json')
parser.add_argument('--sample_rate', default=11025, type=int,
                    help='Sample rate')
# Network architecture
parser.add_argument('--L', default=55, type=int,
                    help='Segment length (55=5ms at 11.025kHZ)')
...
# save and load model
parser.add_argument('--save_folder', default='C:/Users/alexa/OneDrive/Bureau/save_model_1',
                    help='Location to save epoch models')
parser.add_argument('--checkpoint', dest='checkpoint', default=0, type=int,
                    help='Enables checkpoint saving of model')
parser.add_argument('--continue_from', default='',
                    help='Continue from checkpoint model')
parser.add_argument('--model_path', default='final.path.rar',
