...
int main(void)
{
  /* USER CODE BEGIN 1 */
	...
	/*
			...
			//buffer used to store input  and output tensor

			AI_ALIGNED(4) static ai_u8 in_data[AI_NETWORK_1_IN_1_SIZE_BYTES];
			AI_ALIGNED(4) static ai_u8 out_data[AI_NETWORK_1_OUT_1_SIZE_BYTES];

			//Pointeur to our modele

			ai_handle sine_model = AI_HANDLE_NULL;

			//Initialize wrapper structs that hold pointers to dat and info about the
			//data (tensor height,width, channels)

			ai_buffer ai_input[AI_NETWORK_1_IN_NUM] = AI_NETWORK_1_IN;
			ai_buffer ai_output[AI_NETWORK_1_OUT_NUM] = AI_NETWORK_1_OUT;

			//SEt working memory and get weight from model
		...
		// Chunk of memory used to hold the intermediate values for neural network
		    	AI_ALIGNED(32) ai_u32 activations[AI_NETWORK_1_DATA_ACTIVATIONS_SIZE];

		            	// Buffers used to store input and output tensors
		    	AI_ALIGNED(32) ai_i32 in_data[AI_NETWORK_1_IN_1_SIZE_BYTES];
		    	AI_ALIGNED(32) ai_i32 out_data[AI_NETWORK_1_OUT_1_SIZE_BYTES];
