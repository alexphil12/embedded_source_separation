...
/*
	...
	// Chunk of memory used to hold the intermediate values for neural network
	    	AI_ALIGNED(4) ai_u32 activations[AI_NETWORK_1_DATA_ACTIVATIONS_SIZE];

	            	// Buffers used to store input and output tensors
	    	AI_ALIGNED(4) ai_u8 in_data[AI_NETWORK_1_IN_1_SIZE_BYTES];
	    	AI_ALIGNED(4) ai_u8 out_data[AI_NETWORK_1_OUT_1_SIZE_BYTES];
